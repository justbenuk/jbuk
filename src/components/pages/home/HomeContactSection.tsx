...
export default function HomeContactSection() {
  return (
    <div className="border-2 border-dashed border-primary py-12 px-6">
      <div className="flex flex-col items-center justify-center text-center gap-6 md:flex-row md:text-start md:gap-20">
        <div>
          <h1 className="bg-linear-to-br from-foreground to-primary bg-clip-text text-2xl font-bold text-transparent dark:from-white">Do you have a project you want me to work on?</h1>
