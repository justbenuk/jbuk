...
export default function NotFound() {
  return (
    <div className="max-w-4xl mx-auto flex flex-col items-center space-y-4 text-center justify-center min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button asChild size={'lg'} variant={'default'} className="bg-teal-500">
