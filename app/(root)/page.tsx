  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center">
      <Container className="text-center">
        ...
        <p className="lg:w-2/3 mx-auto">I am a self-taught freelance web developer, and I build full stack web applications using NextJS. Take a look at some of my projects to see what I have been working on</p>
