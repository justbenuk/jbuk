    ...
    <Container className="mt-10">
      <div className="grid grid-cols-1 md:grid-cols-3 py-10 gap-10">
        <div className="flex flex-col items-center justify-center space-y-2">
          <MailIcon className="size-10 mb-6 text-teal-500" />
        ...
        <div className="flex flex-col items-center justify-center space-y-2">
          <PhoneIcon className="size-10 mb-6 text-teal-500" />
        ...
        <div className="flex flex-col items-center justify-center space-y-2">
          <PackageIcon className="size-10 mb-6 text-teal-500" />
      ...
      <div className="flex flex-col items-center justify-center space-y-2 py-10 text-center">
        ...
        <h1 className="text-3xl font-semibold text-teal-500">How can I help you?</h1>
      </div>
